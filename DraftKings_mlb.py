...
# Use selenium webdriver to find mlb market odds (wait for all pages to load)
try:
...
for block in game_blocks:
    try:
        ...
        # Pitcher name section
        pitcher_tag = block.select_one("span.cb-market__label-sub-label")
        pitcher = pitcher_tag.text.strip() if pitcher_tag else "Unknown Pitcher"
